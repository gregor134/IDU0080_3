...
public class Tellija {
	...
	private Tellimus createTellimus() {
		...
		tellimus.addTellimuseRida(new TellimuseRida(new Toode(1, "Seiklusjutte maalt ja merelt", new BigDecimal(12.46)), 2));
		tellimus.addTellimuseRida(new TellimuseRida(new Toode(1, "Kus ma olen ja kuidas sina võid palju kaugemale jõuda", new BigDecimal(20.61)), 1));
